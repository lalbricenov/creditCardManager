...
mongoose.connect(process.env.MONGODBATLASURL || 'mongodb+srv://lalbricenov:CXP0aXvrcW3Qq0k1@cluster0-wn3z1.mongodb.net/test?retryWrites=true&w=majority' , {useNewUrlParser: true, useUnifiedTopology: true})
